...
const Testimonial = () => {
  return (
    <section id="testimonials" className="py-16 md:py-24 px-4 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <motion.div variants={fadeIn('up', 0.5)} className="relative">
          ...
          {testimonials.map((testimonial, index) => (
            <SwiperSlide key={testimonial.id} className='h-full md:py-12 py-4'>
              <motion.div
                ...
                className="text-center bg-white p-6 rounded-xl shadow-md h-full flex flex-col transition-all duration-300"
              >
        ...
        <motion.div variants={fadeIn('up', 0.7)} className="flex justify-center gap-4 mt-8">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="swiper-button-prev-custom w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="swiper-button-next-custom w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors"
          >
